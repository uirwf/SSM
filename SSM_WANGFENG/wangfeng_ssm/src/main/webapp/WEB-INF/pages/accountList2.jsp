...
<body>
    ...
    <table align="center" border="1px" width="60%">
        ...
        <c:forEach items="${accountList}" var="account">
            <tr>
                <td align="center" width="15%">${account.id}</td>
                <td align="center" width="40%">${account.money}</td>
                <td align="center" width="15%">${account.uid}</td>
                <td align="center" width="20%"><a href="javascript:void (0);" onclick="updateAccount('${account.id}')">修改</a> </td>
                <td align="center" width="10%"><a href="javascript:void (0);" onclick="delAccount('${account.id}')">删除</a> </td>
            </tr>
        </c:forEach>
