        ...
        <table align="center" border="1px" width="60%">
            ...
            <c:forEach items="${userList}" var="user">
                <tr>
                    ...
                    <!--<td align="center"><a  href="${pageContext.request.contextPath}/user/findUserById/"+${user.id}>修改</a></td>-->
                    <td align="center" width="20%"><a href="javascript:void (0);" onclick="updateUser('${user.id}')">修改</a> </td>
                    <td align="center" width="10%"><a href="javascript:void (0);" onclick="delUser('${user.id}')">删除</a> </td>
                </tr>
            </c:forEach>
